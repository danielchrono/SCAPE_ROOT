...
"SETTINGS_RESET_SUCCESS"      = @{ T='Todas as configurações restauradas para o padrão de fábrica (.psd1).'; H='Confirmação de reset de fábrica'; F='SYSTEM' }
...
"DEPLOYER_OPT_EXE"            = @{ T='BUILD_EXE (Compilar via ps2exe)'; H='Opção de menu build EXE'; F='2' }
"DEPLOYER_OPT_MSI"            = @{ T='BUILD_MSI (Compilar via WiX Toolset)'; H='Opção de menu build MSI'; F='3' }
"DEPLOYER_MATRIX_HEADER"      = @{ T='[ MATRIZ DE DEPLOY SCAPE ]'; H='Cabeçalho do menu deployer'; F=$null }
"DEPLOYER_AUTO_DISCOVERY"     = @{ T='Varrendo escopo por assinaturas de módulos...'; H='Início de auto-descoberta'; F='DEPLOYER_AUTO_DESCOBERTA' }
