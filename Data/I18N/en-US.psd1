...
"DEPLOYER_OPT_EXE"            = @{ T='BUILD_EXE (Compile via ps2exe)'; H='EXE build menu option'; F='2' }
"DEPLOYER_OPT_MSI"            = @{ T='BUILD_MSI (Compile via WiX Toolset)'; H='MSI build menu option'; F='3' }
"DEPLOYER_MATRIX_HEADER"      = @{ T='[ SCAPE DEPLOYMENT MATRIX ]'; H='Deployer menu header'; F=$null }
"DEPLOYER_AUTO_DISCOVERY"     = @{ T='Scanning scope for module signatures...'; H='Auto-discovery start'; F='DEPLOYER_AUTO_DISCOVERY' }
