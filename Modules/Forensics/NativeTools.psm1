...
Register-ScapeActionHandler -Target 'Scape.Forensics.Native.DiskPart' -Handler {
    ...
    Write-ScapeActionProgress -Target $Target -Task $Task -StatusText (Invoke-ScapeI18NFormat -Key "ACTION_TOOL_LAUNCH" -Args @("DISKPART")) -StatusFlag "WARN"
    try {
    ...
    Write-ScapeActionProgress -Target $Target -Task $Task -StatusText (Invoke-ScapeI18NFormat -Key "ACTION_TOOL_COMPLETE" -Args @("DISKPART")) -StatusFlag "Success"
}

Register-ScapeActionHandler -Target 'Scape.Forensics.Native.Chkdsk' -Handler {
    param($Task, $PayloadDef, $Target)
    Write-ScapeActionProgress -Target $Target -Task $Task -StatusText (Invoke-ScapeI18NFormat -Key "ACTION_TOOL_LAUNCH" -Args @("CHKDSK")) -StatusFlag "WARN"
    try {
    ...
    Write-ScapeActionProgress -Target $Target -Task $Task -StatusText (Invoke-ScapeI18NFormat -Key "ACTION_TOOL_COMPLETE" -Args @("CHKDSK")) -StatusFlag "Success"
}

Register-ScapeActionHandler -Target 'Scape.Forensics.Native.WinFR' -Handler {
    param($Task, $PayloadDef, $Target)
    Write-ScapeActionProgress -Target $Target -Task $Task -StatusText (Invoke-ScapeI18NFormat -Key "ACTION_TOOL_LAUNCH" -Args @("WINFR")) -StatusFlag "WARN"
    try {
    ...
    Write-ScapeActionProgress -Target $Target -Task $Task -StatusText (Invoke-ScapeI18NFormat -Key "ACTION_TOOL_COMPLETE" -Args @("WINFR")) -StatusFlag "Success"
}

Register-ScapeActionHandler -Target 'Scape.Forensics.Native.Fsutil' -Handler {
    param($Task, $PayloadDef, $Target)
    Write-ScapeActionProgress -Target $Target -Task $Task -StatusText (Invoke-ScapeI18NFormat -Key "ACTION_TOOL_LAUNCH" -Args @("FSUTIL")) -StatusFlag "WARN"
    try {
    ...
    Write-ScapeActionProgress -Target $Target -Task $Task -StatusText (Invoke-ScapeI18NFormat -Key "ACTION_TOOL_COMPLETE" -Args @("FSUTIL")) -StatusFlag "Success"
}

Register-ScapeActionHandler -Target 'Scape.Forensics.Native.Sfc' -Handler {
    param($Task, $PayloadDef, $Target)
    Write-ScapeActionProgress -Target $Target -Task $Task -StatusText (Invoke-ScapeI18NFormat -Key "ACTION_TOOL_LAUNCH" -Args @("SFC")) -StatusFlag "WARN"
    try {
    ...
    Write-ScapeActionProgress -Target $Target -Task $Task -StatusText (Invoke-ScapeI18NFormat -Key "ACTION_TOOL_COMPLETE" -Args @("SFC")) -StatusFlag "Success"
}

Register-ScapeActionHandler -Target 'Scape.Forensics.Native.Dism' -Handler {
    param($Task, $PayloadDef, $Target)
    Write-ScapeActionProgress -Target $Target -Task $Task -StatusText (Invoke-ScapeI18NFormat -Key "ACTION_TOOL_LAUNCH" -Args @("DISM")) -StatusFlag "WARN"
    try {
    ...
    Write-ScapeActionProgress -Target $Target -Task $Task -StatusText (Invoke-ScapeI18NFormat -Key "ACTION_TOOL_COMPLETE" -Args @("DISM")) -StatusFlag "Success"
}

Register-ScapeActionHandler -Target 'Scape.Forensics.Native.EventVwr' -Handler {
    param($Task, $PayloadDef, $Target)
    Write-ScapeActionProgress -Target $Target -Task $Task -StatusText (Invoke-ScapeI18NFormat -Key "ACTION_TOOL_LAUNCH" -Args @("EVENT VIEWER")) -StatusFlag "WARN"
    try {
    ...
    Write-ScapeActionProgress -Target $Target -Task $Task -StatusText (Invoke-ScapeI18NFormat -Key "ACTION_TOOL_COMPLETE" -Args @("EVENT VIEWER")) -StatusFlag "Success"
}

Register-ScapeActionHandler -Target 'Scape.Forensics.Native.FileHash' -Handler {
    param($Task, $PayloadDef, $Target)
    Write-ScapeActionProgress -Target $Target -Task $Task -StatusText (Invoke-ScapeI18NFormat -Key "ACTION_TOOL_LAUNCH" -Args @("FILEHASH")) -StatusFlag "WARN"
    Publish-ScapeEvent -Type "ACTION_SCREEN_UPDATE" -Severity "INFO" -Payload @{
        ScreenId = "HashScreen"
    ...
    Write-ScapeActionProgress -Target $Target -Task $Task -StatusText (Invoke-ScapeI18NFormat -Key "ACTION_TOOL_COMPLETE" -Args @("FILEHASH")) -StatusFlag "Success"
}
